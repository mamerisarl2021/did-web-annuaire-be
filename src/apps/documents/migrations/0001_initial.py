...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.JSONField(
                        blank=True,
                        help_text="Last published DID document JSON. Immutable once set; overwritten only on next publish.",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.JSONField(
                        blank=True,
                        help_text="Working draft. Editable by members. Becomes content on publish.",
                        null=True,
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        help_text="Member who submitted for review.",
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "method_id_fragment",
                    models.CharField(
                        help_text="Fragment identifier, e.g. 'key-1'. Full ID: did:web:...:org:label#key-1",
                        max_length=64,
                    ),
                ),
                (
        ...
        migrations.AddConstraint(
            model_name="diddocument",
            constraint=models.UniqueConstraint(
                fields=("organization", "label"), name="unique_doc_label_per_org"
            ),
        ),
        migrations.AddConstraint(
