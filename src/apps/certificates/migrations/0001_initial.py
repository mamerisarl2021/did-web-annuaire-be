    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "key_type",
                    models.CharField(help_text="EC, RSA, or Ed25519.", max_length=10),
                ),
                (
                    "key_curve",
                    models.CharField(
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(
                ...
                on_delete=django.db.models.deletion.SET_NULL,
                related_name="+",
                to="certificates.certificateversion",
            ),
        ),
        migrations.AddConstraint(
            model_name="certificateversion",
            constraint=models.UniqueConstraint(
                fields=("certificate", "version_number"), name="unique_version_per_cert"
            ),
        ),
        migrations.AddConstraint(
            model_name="certificate",
            constraint=models.UniqueConstraint(
                fields=("organization", "label"), name="unique_cert_label_per_org"
            ),
        ),
    ]
