...
app.autodiscover_tasks(["src.apps.audits", "src.apps.authentication", "src.apps.files", "src.apps.organizations", "src.apps.emails",
                        "src.apps.users", "src.apps.superadmin", "src.seeders"])
